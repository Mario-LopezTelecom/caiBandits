classdef e_greedy_rate_algo < handle
   ...
   methods
       function this = e_greedy_rate_algo (epsilon,rate)
       ...
       function update(this,chosen_arm,reward)
           %{ 
             ...
             recompensa
           %}
           this.clicks(chosen_arm) = this.rate.*this.clicks(chosen_arm) + reward;
           this.trials(chosen_arm) = this.rate.*this.trials(chosen_arm) + 1;
       end
   end
end